...
## Bandit 26->27
  ...
  - Bài này chỉ đơn giản là git clone custom port.
  ![image](https://github.com/TooBunReal/bandit-wu/assets/89735990/129d5160-21d0-4f2c-8c7f-3bb1e871bd7f)
  
  pass: ```AVanL161y9rsbcJIsFHuw35rjaOM19nR```
  
## Bandit 27->28
  ```ssh bandit28@bandit.labs.overthewire.org -p 2220:AVanL161y9rsbcJIsFHuw35rjaOM19nR```
  - Để xem được lịch sử commit và thay đổi, ta dùng ```git log -p```

  ![image](https://github.com/TooBunReal/bandit-wu/assets/89735990/321f2447-522b-46bc-8918-d45a88efa93a)

  pass: ```tQKvmcwNYcFS6vmPHIUSI3ShmsrQZK8S```
  
## Bandit 28->29
  ```ssh bandit29@bandit.labs.overthewire.org -p 2220:tQKvmcwNYcFS6vmPHIUSI3ShmsrQZK8S```
  ![image](https://github.com/TooBunReal/bandit-wu/assets/89735990/2af4ce23-49e1-4a29-aaff-cc2494d4639d)

  - Vì check git log không thấy gì thay đổi nên mình đã tìm thử ở branch khác của repo.
  ![image](https://github.com/TooBunReal/bandit-wu/assets/89735990/ae082b38-b5af-4a7c-b213-db34336fe404)

  - Minh checkout qua dev thì có pass.
